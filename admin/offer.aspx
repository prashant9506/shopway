        ...
        <table class="auto-style1">
            ...
            <tr>
                <td class="auto-style2" colspan="2">
                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click1" Text="Send offer" Width="140px" />
                </td>
            </tr>
        </table>
       <hr />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"  SelectCommand="SELECT * FROM [offer]" DeleteCommand="DELETE FROM [offer] WHERE [id] = @id" InsertCommand="INSERT INTO [offer] ([offer], [status]) VALUES (@offer, @status)" UpdateCommand="UPDATE [offer] SET [offer] = @offer, [status] = @status WHERE [id] = @id">
            <DeleteParameters>
